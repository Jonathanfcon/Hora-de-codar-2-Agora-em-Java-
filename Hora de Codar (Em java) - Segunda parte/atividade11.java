...
public class atividade11 {
    ...
    public static void main (String[] args) {
        ...
        System.out.println("Agora informe qual a marcacao no fim do dia:");
       double fim = in.nextInt();

        System.out.println("Agora informe quantos litros de gasolina foram gastos no dia:");
       double litros = in.nextInt();

        System.out.println("Informe quanto foi o valor recebido dos passagueiros no dia");
       double lucro = in.nextInt();
